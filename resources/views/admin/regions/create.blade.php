...
<div class="row justify-content-center">
    <div class="col-md-7">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="fw-semibold mb-4" style="color:#1a1a2e;">Yangi region</h5>
                ...
                <form method="POST" action="{{ route('admin.regions.store') }}">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('admin.regions.index') }}" class="btn btn-outline-primary">Bekor qilish</a>
                    </div>
                </form>
            </div>
        </div>
